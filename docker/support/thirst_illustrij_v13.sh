...
# Model files
declare -A MODELS=(
    ["https://huggingface.co/LoopsBoops/furarch/resolve/main/illustrij_v13.safetensors"]="illustrij_v13.safetensors"
)
...
function provisioning_start() {
    ...
    echo "Provisioning completed at $(date)" > "${WORKSPACE}/ComfyUI/input/provisioned_thirst_illustrij_v13.txt"
