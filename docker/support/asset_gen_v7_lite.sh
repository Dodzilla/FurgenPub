...
export COMFYUI_PIN_COMMIT="${COMFYUI_PIN_COMMIT:-73c9bad4d21e7addbe1d13bc92eee0f1431b017d}"
export ASSET_GEN_V5_DEFAULT_BOOTSTRAP_BUNDLES="${ASSET_GEN_V5_DEFAULT_BOOTSTRAP_BUNDLES:-asset_gen_v5_runtime_helpers,asset_gen_v5_flux_image}"
export ASSET_GEN_V5_IGNORED_BUNDLE_IDS="${ASSET_GEN_V5_IGNORED_BUNDLE_IDS:-asset_gen_v6_lite_comfy_core_v0251,asset_gen_v6_lite_runtime_helpers,asset_gen_v5_omnivoice}"
