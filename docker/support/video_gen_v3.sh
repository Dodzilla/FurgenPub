...
function dependency_manager_persist_agent_env() {
    ...
    for key in \
        ...
        CIVITAI_TOKEN \
        COMFYUI_ARGS \
        FURGEN_H3_ATTENTION_BACKEND \
        FURGEN_H3_SAGEATTENTION_VERSION \
        FURGEN_H3_SAGEATTENTION_COMMIT \
        FURGEN_H3_SAGEATTENTION_WHEEL_URL \
        FURGEN_H3_SAGEATTENTION_WHEEL_SHA256 \
        FURGEN_H3_SAGEATTENTION_WHEEL_SIZE_BYTES \
        FURGEN_H3_PYTORCH_RUNTIME_VERSION \
        FURGEN_RTX_VSR_VERSION \
        NVIDIAVFX_LIB_DIR \
        LD_LIBRARY_PATH \
