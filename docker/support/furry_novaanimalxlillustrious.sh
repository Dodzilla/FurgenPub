...
# Model files
declare -A MODELS=(
    ["https://huggingface.co/LoopsBoops/furarch/resolve/main/novaAnimalXL_illustriousV20.safetensors"]="novaAnimalXL_illustriousV20.safetensors"
)
...
function provisioning_start() {
    ...
    echo "Provisioning completed at $(date)" > "${WORKSPACE}/ComfyUI/input/provisioned_furry_novaanimalxlillustrious.txt"
