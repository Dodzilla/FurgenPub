...
BUNDLES = ['asset_gen_v5_runtime_helpers', 'asset_gen_v5_flux_image', 'asset_gen_v7_lite_breeze_tts2',
           'asset_gen_v7_lite_qwen_image_21']
CORE = '73c9bad4d21e7addbe1d13bc92eee0f1431b017d'  # ComfyUI v0.37.0: first release with QwenImage21
PACKAGES = {'torch': '2.10.0+cu130', 'torchvision': '0.25.0+cu130', 'torchaudio': '2.10.0+cu130',
            'transformers': '5.3.0', 'comfy-kitchen': '0.2.35', 'comfy-aimdo': '0.5.5'}
...
def snapshot(root, runtime):
    ...
    required_nodes = {'easy-comfy-nodes-async', 'ComfyUI_essentials', 'ComfyUI-NAG', 'ComfyUI_Comfyroll_CustomNodes', 'was-node-suite-comfyui', 'ComfyUI-Breeze-TTS-2', 'ComfyUI-GGUF'}
