...
# These workflow-wiring helpers preserve the exact class names and behavior
# from easy-comfy-nodes-async revision a7d58d21de8a47fc42537c204650f9c03066f22a.
# Its MIT license is bundled under THIRD_PARTY_LICENSES/.
class _FurgenAnyType(str):
    def __ne__(self, other):
        return False


_FURGEN_ANY_TYPE = _FurgenAnyType("*")


class EZHttpPostNode:
    @classmethod
    def INPUT_TYPES(cls):
...
class ImpactExecutionOrderController:
    @classmethod
    def INPUT_TYPES(cls):
        return {"required": {"signal": (_FURGEN_ANY_TYPE,), "value": (_FURGEN_ANY_TYPE,)}}

    RETURN_TYPES = (_FURGEN_ANY_TYPE, _FURGEN_ANY_TYPE)
...
class FCSExposeCompositionTiming:
    ...
    def expose(self, filenames):
        ...
        root = Path(
            folder_paths.get_output_directory() if saved else folder_paths.get_temp_directory()
        ).resolve()
...
NODE_CLASS_MAPPINGS = {
    ...
    "EZHttpPostNode": EZHttpPostNode,
    "EZEmptyDictNode": EZEmptyDictNode,
    "EZAssocStrNode": EZAssocStrNode,
    "ImpactExecutionOrderController": ImpactExecutionOrderController,
    "FCSExposeCompositionTiming": FCSExposeCompositionTiming,
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    "FCSConcatVideosV4GlobalGrid": "Furgen Concat Videos V4 (global grid)",
    ...
    "FCSExposeCompositionTiming": "Expose Composition Timing",
