...
AGENT_VERSION = "dm-agent-py/0.10.49"
VIDEO_GEN_V2_FURGENPUB_COMMIT = "44ea312e17585be9107bd9952613501a1d99b336"
...
class LTXAddVideoICLoRAGuide:
    ...
    def execute(self, positive, negative, vae, latent, image, frame_idx=0, strength=0.65, latent_downscale_factor=None, crop="center", use_tiled_encode=False, tile_size=256, tile_overlap=64):
